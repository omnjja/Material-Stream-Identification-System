...
TEST_SIZE = 0.2
RANDOM_STATE = 42
UNKNOWN_THRESHOLD = 0.6  # Confidence threshold for "Unknown" class (ID=6)
...
# SVM Predictions
# --------------------------
y_pred_svm = predict_with_rejection(svm_clf, X_val, threshold=UNKNOWN_THRESHOLD)
...
# k-NN Predictions
# --------------------------
y_pred_knn = predict_with_rejection(knn_clf, X_val, threshold=UNKNOWN_THRESHOLD)
